...
def menu():
    ...
    print W + ' 2.' + G + ' Show Group ID\'s'
    print W + ' 3.' + G + ' Show Phone Numbers'
    print W + ' 4.' + G + ' Profile Guard'
    print W + ' 5.' + G + ' Auto liker'
    print W + ' 6.' + G + ' Auto Report'
    print W + ' 7.' + G + ' Developer&info'
    print W + ' 8.' + G + ' Logout'
    print W + ' 0.' + R + ' Exit'
    print ''
    pilih()
...
def pilih():
    ...
    if zedd == '':
        ...
        os.system('clear')
        print ' \033[1;93mRecoded : \033[1;92mSultan_Shariar\n \033[1;93mTeam : \033[1;92mTermux Commands  \n \033[1;93mTelegram : \033[1;92mhttps://t.me/httpTremaxcommands \n\033[1;93m Github : \033[1;92mhttps://www.github.com/Shazada-shariar \n\033[1;91m Caeted by : \033[1;97mSultan Shariar ((*KING*))'
        print '\n'
